...
// Todavia solo hay arte para los niveles 1-3; el nivel 4 reusa el aspecto
// del nivel 3 hasta que se agreguen esos frames.
class TankSpriteSet {
public:
...
private:
    static constexpr int kLoadedLevels = 3;
